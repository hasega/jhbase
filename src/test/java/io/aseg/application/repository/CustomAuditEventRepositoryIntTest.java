package io.aseg.application.repository;

import io.aseg.application.JhbaseApp;
import io.aseg.application.config.Constants;
import io.aseg.application.config.audit.AuditEventConverter;
import io.aseg.application.domain.PersistentAuditEvent;
...
import static io.aseg.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
